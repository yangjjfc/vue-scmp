    ...
    <el-row>
        <el-col :span="24" class="toolbar">
            <el-form :inline="true">
                ...
                <el-form-item>
                    <el-select size="small" v-model="search.pastType" placeholder="请选择" @change="getList()">
                        <el-option v-for="item in sourceType" :label="item.text" :value="item.id" :key='item.id'>
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
                    <el-input placeholder="供应商名称/授权单位" v-model="search.keywords" class="w300" size="small"></el-input>
                </el-form-item>
